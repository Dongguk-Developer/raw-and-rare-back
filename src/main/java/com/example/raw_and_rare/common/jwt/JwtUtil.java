package com.example.raw_and_rare.common.jwt;
...
public class JwtUtil {
    ...
    public void checkAccessToken(String token) throws JwtException {
        if(!isTokenValid(token))
            throw new JwtException("유저 로그인 정보가 없거나 유효하지 않습니다");
    }
}